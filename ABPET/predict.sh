...
#     bash predict.sh /projectnb/medaihack/ABPET/data/val.csv /projectnb/medaihack/team20/medaihack/ABPET/checkpoints/best_model.pt my_predictions.csv
set -euo pipefail
...
source "/projectnb/medaihack/team20/.venv/bin/activate" # Participants, please hardcode the path to YOUR TEAM's desired virtual env. This is the venv we will activate for evaluation.
